...
/**
 * Defines constant string values used as command identifiers for image processing operations.
 *
 * <p>These constants represent the defined set of commands which are supported, such as loading,
